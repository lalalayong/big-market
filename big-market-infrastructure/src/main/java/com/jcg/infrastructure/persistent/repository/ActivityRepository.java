...
import com.jcg.domain.activity.event.ActivitySkuStockZeroMessageEvent;
...
import com.jcg.domain.activity.model.valobj.UserRaffleOrderStateVO;
import com.jcg.domain.activity.repository.IActivityRepository;
import com.jcg.infrastructure.event.EventPublisher;
import com.jcg.infrastructure.persistent.dao.*;
import com.jcg.infrastructure.persistent.po.*;
        ...
        try {
            ...
            transactionTemplate.execute(status -> {
                try {
                    ...
                    // 如果月、日额度存在则更新，不存在则不更新。不存在时候，在用户发起抽奖的时候是可以动态的从总账户中，创建出月和日额度账户的。
                    // 4. 更新账户 - 月
