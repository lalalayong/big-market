...
public class DataSourceConfig {
    ...
    @Configuration
    @MapperScan(basePackages = "com.jcg.infrastructure.elasticsearch", sqlSessionFactoryRef = "elasticsearchSqlSessionFactory")
    ...
    @Configuration
    @MapperScan(basePackages = "com.jcg.infrastructure.dao", sqlSessionFactoryRef = "mysqlSqlSessionFactory")
