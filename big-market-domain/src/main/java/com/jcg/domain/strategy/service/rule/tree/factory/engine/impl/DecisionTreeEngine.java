package com.jcg.domain.strategy.service.rule.tree.factory.engine.impl;

import com.jcg.domain.strategy.model.valobj.RuleLogicCheckTypeVO;
import com.jcg.domain.strategy.model.valobj.RuleTreeNodeLineVO;
import com.jcg.domain.strategy.model.valobj.RuleTreeNodeVO;
...
public class DecisionTreeEngine implements IDecisionTreeEngine {
    ...
    public DefaultTreeFactory.StrategyAwardData process(String userId, Long strategyId, Integer awardId) {
        ...
        while (null != nextNode) {
            ...
            log.info("决策树引擎【{}】treeId:{}  node:{}  code:{}  info:{}", ruleTreeVO.getTreeName(), ruleTreeVO.getTreeId(), nextNode, ruleLogicCheckTypeVO.getCode(), ruleLogicCheckTypeVO.toString());
